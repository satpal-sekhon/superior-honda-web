                                ...
                                <div class="shop__sidebar--product">
                                    <div class="small__product--card d-flex">
                                        <div class="small__product--thumbnail">
                                            <a class="display-block" href="product-details.html"><img src="{{ asset('assets/images/product/small-product/product6.webp') }}" alt="product-img"></a>
                                        </div>
                                    ...
                                    <div class="small__product--card d-flex">
                                        <div class="small__product--thumbnail">
                                            <a class="display-block" href="product-details.html"><img src="{{ asset('assets/images/product/small-product/product7.webp')}}" alt="product-img"></a>
                                        </div>
                                        <div class="small__product--content">
                                    ...
                                    <div class="small__product--card d-flex">
                                        <div class="small__product--thumbnail">
                                            <a class="display-block" href="product-details.html"><img src="{{ asset('assets/images/product/small-product/product8.webp')}}" alt="product-img"></a>
                                        </div>
                                        <div class="small__product--content">
