    ...
    <div class="offcanvas__filter--sidebar__inner">
                ...
                <li class="widget__categories--menu__list">
                    <label class="widget__categories--menu__label d-flex align-items-center">
                        <img class="widget__categories--menu__img"
                            src="{{ env('BASE_IMAGE_PATH') . '/' . $productCategory->category_image }}"
                            alt="categories-img">
                        ...
                        <li class="widget__categories--sub__menu--list">
                            <a class="widget__categories--sub__menu--link d-flex align-items-center"
                                ...
                                <img class="widget__categories--sub__menu--img"
                                    src="{{ env('BASE_IMAGE_PATH') . '/' . $productCategory->productImages->images }}"
                                    alt="categories-img">
                    ...
                    <div class="price__filter--group">
                        ...
                        <div class="price__filter--input">
                            ...
                            <input class="price__filter--input__field border-0" name="filter.v.price.gte"
                                id="Filter-Price-GTE" type="number" placeholder="0" min="0" max="250.00">
                        </div>
                    </div>
        ...
        <div class="single__widget widget__bg">
            ...
            <div class="shop__sidebar--product">
                ...
                <div class="small__product--card d-flex">
                    <div class="small__product--thumbnail">
                        <a class="display-block" href="#"><img
                                src="{{ asset('assets/images/product/small-product/product8.webp') }}"
                                alt="product-img"></a>
                    </div>
                    <div class="small__product--content">
        ...
        <div class="single__widget widget__bg">
            ...
            <ul class="widget__tagcloud">
                ...
                <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="#"> {{ $brand->brand_name
                        }}</a></li>
                @endforeach
            </ul>
        </div>
                                    ...
                                    <article class="product__card">
                                        <div class="product__card--thumbnail">
                                            ...
                                            <ul
                                                ...
                                                <li class="product__card--action__list">
                                                    <a class="product__card--action__btn wishlist-btn" title="Wishlist"
                                                        data-id="{{ $product->id }}"
                                        ...
                                        <div class="product__card--content">
                                            ...
                                            <h3 class="product__card--title"><a href="#">{{
                                                    ucwords($product->product_name) }}
                                                </a></h3>
                                            <div class="product__card--price">
                                                <span class="current__price">${{ number_format($product->cost_price, 2)
                                                    }}</span>
                                                <span class="old__price">${{ number_format($product->cost_price, 2)
                                                    }}</span>
                                            </div>
                            ...
                            <div class="col mb-30">
                                <div class="product__card product__list d-flex align-items-center">
                                    ...
                                    <div class="product__card--content product__list--content">
                                        <h3 class="product__card--title"><a href="#">{{ $product->product_name }} </a>
                                        </h3>
                                        <ul class="rating product__card--rating d-flex">
                                            <li class="rating__list">
                                                <span class="rating__icon">
            ...
            <div class="pagination__area">
                <nav class="pagination justify-content-center">
                    ...
                    <li class="page-item pagination__list">
                        <a class="page-link pagination__item--arrow  link" href="{{ $products->previousPageUrl() }}"
                    ...
                    <li class="page-item pagination__list">
                        <a class="page-link pagination__item--arrow  link" href="{{ $products->nextPageUrl() }}"
