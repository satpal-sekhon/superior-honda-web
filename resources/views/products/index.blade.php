                        ...
                        <div class="shop__sidebar--widget widget__area d-none d-lg-block">
                                ...
                                <ul class="widget__categories--menu">
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="{{ asset('assets/images/product/small-product/product1.webp') }}" alt="categories-img">
                                        ...
                                        <ul class="widget__categories--sub__menu">
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="#">
                                                    <img class="widget__categories--sub__menu--img" src="{{ asset('assets/images/product/small-product/product2.webp') }}" alt="categories-img">
                                                    <span class="widget__categories--sub__menu--text">Discount Weekly</span>
                                                </a>
                                            </li>
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="#">
                                                    <img class="widget__categories--sub__menu--img" src="{{ asset('assets/images/product/small-product/product3.webp') }}" alt="categories-img">
                                                    <span class="widget__categories--sub__menu--text">Green dhaniya</span>
                                                </a>
                                            </li>
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="#">
                                                    <img class="widget__categories--sub__menu--img" src="{{ asset('assets/images/product/small-product/product4.webp') }}" alt="categories-img">
                                                    <span class="widget__categories--sub__menu--text">resh Nuts</span>
                                                </a>
                                            </li>
                                            <li class="widget__categories--sub__menu--list">
                                                <a class="widget__categories--sub__menu--link d-flex align-items-center" href="#">
                                                    <img class="widget__categories--sub__menu--img" src="{{ asset('assets/images/product/small-product/product5.webp') }}" alt="categories-img">
                                    ...
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="{{ asset('assets/images/product/small-product/product2.webp') }}" alt="categories-img">
                                    ...
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="{{ asset('assets/images/product/small-product/product3.webp') }}" alt="categories-img">
                                    ...
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="{{ asset('assets/images/product/small-product/product4.webp') }}" alt="categories-img">
                                    ...
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="{{ asset('assets/images/product/small-product/product5.webp') }}" alt="categories-img">
                                ...
                                <div class="shop__sidebar--product">
                                    <div class="small__product--card d-flex">
                                        ...
                                        <div class="small__product--content">
                                            <h3 class="small__product--card__title"><a href="#l">Black Air Pods </a></h3>
                            ...
                            <div class="single__widget widget__bg">
                                ...
                                <ul class="widget__tagcloud">
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="#"> Paintworks
                                    </a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="#">Lighting</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="#">Gaming</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="#">Bumpers </a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="#">Hoods </a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="#">Air Boxes</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="#">Fog Lights</a></li>
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="#">Interior </a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="categories__shop mb-50">
                                ...
                                <ul class="categories__shop--inner">
                                    <li class="categories__shop--card">
                                        <a class="categories__shop--card__link" href="{{ route('products.create') }}">
                                            <div class="categories__thumbnail mb-15">
                                                <img class="categories__thumbnail--img" src="{{ asset('assets/images/product/main-product/product1.webp') }}" alt="categories-img">
                                            </div>
                                    ...
                                    <li class="categories__shop--card">
                                        <a class="categories__shop--card__link" href="#">
                                            <div class="categories__thumbnail mb-15">
                                                <img class="categories__thumbnail--img" src="{{ asset('assets/images/product/main-product/product2.webp') }}" alt="categories-img">
                                            </div>
                                            <div class="categories__content">
                                    ...
                                    <li class="categories__shop--card">
                                        <a class="categories__shop--card__link" href="#">
                                            <div class="categories__thumbnail mb-15">
                                                <img class="categories__thumbnail--img" src="{{ asset('assets/images/product/main-product/product3.webp') }}" alt="categories-img">
                                            </div>
                                            <div class="categories__content">
                                    ...
                                    <li class="categories__shop--card">
                                        <a class="categories__shop--card__link" href="#">
                                            <div class="categories__thumbnail mb-15">
                                                <img class="categories__thumbnail--img" src="{{ asset('assets/images/product/main-product/product4.webp') }}" alt="categories-img">
                                            </div>
                                            <div class="categories__content">
                                    ...
                                    <li class="categories__shop--card">
                                        <a class="categories__shop--card__link" href="#">
                                            <div class="categories__thumbnail mb-15">
                                                <img class="categories__thumbnail--img" src="{{ asset('assets/images/product/main-product/product5.webp') }}" alt="categories-img">
                                            </div>
                                            <div class="categories__content">
                                    ...
                                    <li class="categories__shop--card">
                                        <a class="categories__shop--card__link" href="#">
                                            <div class="categories__thumbnail mb-15">
                                                <img class="categories__thumbnail--img" src="{{ asset('assets/images/product/main-product/product6.webp') }}" alt="categories-img">
                                            </div>
                                            <div class="categories__content">
                                    ...
                                    <li class="categories__shop--card">
                                        <a class="categories__shop--card__link" href="#">
                                            <div class="categories__thumbnail mb-15">
                                                <img class="categories__thumbnail--img" src="{{ asset('assets/images/product/main-product/product11.webp') }}" alt="categories-img">
                                            </div>
                                            <div class="categories__content">
                                    ...
                                    <li class="categories__shop--card">
                                        <a class="categories__shop--card__link" href="#">
                                            <div class="categories__thumbnail mb-15">
                                                <img class="categories__thumbnail--img" src="{{ asset('assets/images/product/main-product/product12.webp') }}" alt="categories-img">
                                            </div>
                                            <div class="categories__content">
                                                    ...
                                                    <article class="product__card">
                                                        <div class="product__card--thumbnail">
                                                            ...
                                                            <ul class="product__card--action d-flex align-items-center justify-content-center">
                                                                ...
                                                                <li class="product__card--action__list">
                                                                    <a class="product__card--action__btn" title="Wishlist" href="{{ route('wishlists.index')}}">
                                                    ...
                                                    <article class="product__card">
                                                        <div class="product__card--thumbnail">
                                                            ...
                                                            <ul class="product__card--action d-flex align-items-center justify-content-center">
                                                                ...
                                                                <li class="product__card--action__list">
                                                                    <a class="product__card--action__btn" title="Wishlist" href="{{ route('wishlist.index') }}">
                                                                        <svg class="product__card--action__btn--svg" width="18" height="18" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M13.5379 1.52734C11.9519 0.1875 9.51832 0.378906 8.01442 1.9375C6.48317 0.378906 4.04957 0.1875 2.46364 1.52734C0.412855 3.25 0.713636 6.06641 2.1902 7.57031L6.97536 12.4648C7.24879 12.7383 7.60426 12.9023 8.01442 12.9023C8.39723 12.9023 8.7527 12.7383 9.02614 12.4648L13.8386 7.57031C15.2879 6.06641 15.5886 3.25 13.5379 1.52734ZM12.8816 6.64062L8.09645 11.5352C8.04176 11.5898 7.98707 11.5898 7.90504 11.5352L3.11989 6.64062C2.10817 5.62891 1.91676 3.71484 3.31129 2.53906C4.3777 1.63672 6.01832 1.77344 7.05739 2.8125L8.01442 3.79688L8.97145 2.8125C9.98317 1.77344 11.6238 1.63672 12.6902 2.51172C14.0847 3.71484 13.8933 5.62891 12.8816 6.64062Z" fill="currentColor"/>
                                                                        </svg>
                                                                        <span class="visually-hidden">Wishlist</span> 
