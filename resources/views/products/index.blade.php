                                    ...
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img"
                                                src="{{ env('BASE_IMAGE_PATH') . '/' . $category->category_image }}"
                                                alt="categories-img">
                                            <span
                                                class="widget__categories--menu__text">{{ ucwords($category->name) }}</span>
                                                ...
                                                <li class="widget__categories--sub__menu--list">
                                                    <a class="widget__categories--sub__menu--link d-flex align-items-center"
                                                        ...
                                                        <img class="widget__categories--sub__menu--img"
                                                            src="{{ env('BASE_IMAGE_PATH') . '/' . $category->productImages->images }}"
                                                            alt="categories-img">
                                                        <span
                                                            class="widget__categories--sub__menu--text">{{ $product->product_name }}</span>
                                                    </a>
                                                </li>
                                            @endforeach
                                        </ul>
                        ...
                        <div class="single__widget widget__bg">
                            ...
                            <div class="shop__sidebar--product">
                                ...
                                <div class="small__product--card d-flex">
                                    ...
                                    <div class="small__product--content">
                                        <h3 class="small__product--card__title"><a href="#">Lorem ipsum sit. </a>
                                        </h3>
                                        <div class="small__product--card__price">
                        ...
                        <div class="single__widget widget__bg">
                            ...
                            <ul class="widget__tagcloud">
                                @foreach ($brands as $brand)
                                    <li class="widget__tagcloud--list"><a class="widget__tagcloud--link" href="#">
                                ...
                                @foreach ($productCategories as $key => $productCategory)
                                    <li class="categories__shop--card">
                                        <a class="categories__shop--card__link"
                                            href="{{ route('products.category-products', $productCategory->id) }}">
                                            <div class="categories__thumbnail mb-15">
                                                <img class="categories__thumbnail--img"
                                                    ...
                                                    alt="categories-img" style="width:50" height="50">
                                            </div>
                                            <div class="categories__content">
                                                <h2 class="categories__content--title">
                                                    {{ ucwords($productCategory->name) }}</h2>
                                                <span class="categories__content--subtitle">{{ $productCategory->items }}
                                                    items</span>
                                            </div>
                                        </a>
                                    </li>
