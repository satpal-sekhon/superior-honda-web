                                ...
                                <ul class="widget__categories--menu">
                                    ...
                                    <li class="widget__categories--menu__list">
                                        <label class="widget__categories--menu__label d-flex align-items-center">
                                            <img class="widget__categories--menu__img" src="{{ env('BASE_IMAGE_PATH').'/'.$category->category_image }}" alt="categories-img">
                                            <span class="widget__categories--menu__text">{{ ucwords($category->name) }}</span>
                                    ...
                                    <li class="categories__shop--card">
                                        <a class="categories__shop--card__link" href="{{ route('products.create') }}">
                                            <div class="categories__thumbnail mb-15">
                                                <img class="categories__thumbnail--img" src="{{ env('BASE_IMAGE_PATH').'/'.$productCategory->category_image }}" alt="categories-img" style="width:50" height="50">
                                            </div>
                                            <div class="categories__content">
                                                <h2 class="categories__content--title">{{ ucwords($productCategory->name) }}</h2>
                                                <span class="categories__content--subtitle">{{ $productCategory->items }} items</span>
                                            </div>
                                        </a>
                                    </li>
                                    @endforeach
